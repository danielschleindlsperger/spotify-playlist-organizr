app.config(function (SpotifyProvider) {
	...
	SpotifyProvider.setScope('user-read-private user-read-email user-library-read playlist-read-private user-top-read playlist-modify-private playlist-modify-public');
